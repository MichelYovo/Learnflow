...
const COEUR: Schema3DModel = {
  ...
  image: require("../../assets/schemas/coeur.png"),
  parts: [
...
const NEURONE: Schema3DModel = {
  ...
  image: require("../../assets/schemas/neurone.png"),
  parts: [
...
const REIN: Schema3DModel = {
  ...
  image: require("../../assets/schemas/rein.png"),
  parts: [
...
const DIGESTIF: Schema3DModel = {
  ...
  image: require("../../assets/schemas/digestif.png"),
  parts: [
...
const OEIL: Schema3DModel = {
  ...
  image: require("../../assets/schemas/oeil.png"),
  parts: [
...
const POUMONS: Schema3DModel = {
  ...
  image: require("../../assets/schemas/poumons.png"),
  parts: [
...
const CELLULE: Schema3DModel = {
  ...
  image: require("../../assets/schemas/cellule.png"),
  parts: [
...
const REPRO_F: Schema3DModel = {
  ...
  image: require("../../assets/schemas/repro-f.png"),
  parts: [
...
const REPRO_H: Schema3DModel = {
  ...
  image: require("../../assets/schemas/repro-h.png"),
  parts: [
...
const FECONDATION: Schema3DModel = {
  ...
  image: require("../../assets/schemas/fecondation.png"),
  parts: [
...
const MUSCLE: Schema3DModel = {
  ...
  image: require("../../assets/schemas/muscle.png"),
  parts: [
...
const FLEUR: Schema3DModel = {
  ...
  image: require("../../assets/schemas/fleur.png"),
  parts: [
...
const TERRE: Schema3DModel = {
  ...
  image: require("../../assets/schemas/terre.png"),
  parts: [
...
const MEIOSE: Schema3DModel = {
  ...
  image: require("../../assets/schemas/meiose.png"),
  parts: [
