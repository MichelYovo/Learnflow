export const ADMIN_LINKS = [
  { href: "/dashboard", label: "Vue d’ensemble", short: "Aperçu" },
  ...
  { href: "/dashboard/schemas", label: "Schémas 3D", short: "Schémas" },
  { href: "/dashboard/programme", label: "Programme APC", short: "Programme" },
  { href: "/dashboard/parametres", label: "Paramètres", short: "Réglages" },
] as const;
